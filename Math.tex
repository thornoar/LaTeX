\usepackage{amsmath, amsthm, amssymb, dsfont, euscript, MnSymbol}
...
% \newcommand{\restr}[2]{
%     \underset
%     {\displaystyle \hphantom{#1 \hspace{2pt}} \smash{\big |} \lefteqn{\phantom{bruh}} \lefteqn{\hspace{2pt} \smash{\lefteqn{\phantom{bruh}}_{\displaystyle #2}}}}
%     {{#1 \hspace{2pt}} {\big |}}\hspace{3pt}
% }

% \newcommand{\restrmid}[2]{
%     \genfrac{}{}{0pt}{0}{#1}{\vphantom{#2}}\left| \genfrac{}{}{0pt}{0}{\lefteqn{\vphantom{#1}}}{#2} \right.
% }
